...
local towers = {
    {
        id = "ef0385b6-5899-4279-8bb8-f3a2a1f6285e", -- Baller
        position = Vector3.new(-1387.10400390625, 3, 1233.759033203125),
        uniqueId = "{bf54f22d-b808-44e8-9420-1abefdde45e9}",
        towerIndex = 1,
    ...
    {
        id = "2637c9ec-28dd-42bb-b51b-2ba7cfc48b17", -- GMK1
        position = Vector3.new(-1378.749267578125, 3, 1224.6224365234375),
        uniqueId = "{035e1411-66ff-4c8b-8103-b437b422bb1b}",
        towerIndex = 2,
    ...
    {
        id = "204b6969-18ab-412f-b2a8-c0531110cdad", -- GMK2
        position = Vector3.new(-1379.74365234375, 3, 1218.7728271484375),
        uniqueId = "{100235ce-3081-4a67-9200-6d5671b309c7}",
        towerIndex = 3,
        towerUpgradeNr = {2, 3, 4, 5},  -- Numerki ulepszeń
        costs = {2000, 10000, 50000, 150000}, -- Koszty ulepszeń
        currentUpgrade = 1  -- Obecny poziom ulepszenia
    ...
    {
        id = "675adc34-254d-4390-93c4-b9adce6c3397", -- Brain
        position = Vector3.new(-1394.7928466796875, 3, 1226.414794921875),
        uniqueId = "{b91cdd9d-2068-4f17-80b9-62baebf4ca49}",
        towerIndex = 4,
    ...
    {
        id = "3996415d-c74c-4c70-9110-41abb926f3bf",
        position = Vector3.new(-1396.398193359375, 3, 1229.431640625),
        towerIndex = 5,
        uniqueId = "{d0344862-32eb-4f87-905e-d391b7e594f7}",
        towerUpgradeNr = {2, 3, 4, 5, 6, 7, 8},  -- Numerki ulepszeń
