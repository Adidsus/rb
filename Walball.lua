...
local towers = {
    {
        id = "1e90cf54-927b-4bdb-8ecd-0dc30c1ab69b", -- Baller
        position = Vector3.new(-1387.0689697265625, 3, 1233.599609375),
        uniqueId = "{42D4D48C-7AFB-44DB-B512-FBE99703983D}",
        towerIndex = 1,
    ...
    {
        id = "93e74419-5bfd-42bc-b0e1-7f907593d9ee", -- GMK1
        position = Vector3.new(-1377.84375, 3, 1224.8896484375),
        uniqueId = "{5CF4764A-DE85-48EF-950F-654A554A6409}",
        towerIndex = 2,
    ...
    {
        id = "9025cff0-9e10-41aa-8aed-8d20a8e06cd9", -- GMK2
        position = Vector3.new(-1377.76123046875, 3, 1218.8109130859375),
        uniqueId = "{85DB8CFE-564D-4016-A09E-33033967D47A}",
        towerIndex = 3,
        towerUpgradeNr = {2, 3, 4, 5},  -- Numerki ulepszeń
        costs = {2000, 10000, 50000, 150000}, -- Koszty ulepszeń
        currentUpgrade = 1  -- Obecny poziom ulepszenia
    ...
    {
        id = "7c2f0ec1-3eef-4264-904a-42006c757561", -- Brain
        position = Vector3.new(-1396.6494140625, 3, 1224.8118896484375),
        uniqueId = "{C7250D01-C4CA-445A-87E9-4789B0F992C5}",
        towerIndex = 4,
    ...
    {
        id = "9c983413-e3ef-43c1-b5fc-a56b1d166385",
        position = Vector3.new(-1396.772705078125, 3, 1231.6253662109375),
        towerIndex = 5,
        uniqueId = "{979280ED-7AAE-4DEC-97BD-53D2584099A9}",
        towerUpgradeNr = {2, 3, 4, 5, 6, 7, 8},  -- Numerki ulepszeń
